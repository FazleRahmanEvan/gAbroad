    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-20 mb-20  lg:p-12 lg:ml-8">
      <div className="card w-80 bg-base-100 shadow-xl border-2 border-secondary">
        <div className="card-body">
          ...
          <div className="card-actions justify-end mr-2 mt-2 ">
            <Link to="/visaCanada"><button className="btn btn-sm btn-primary text-white">
            Find More
            </button></Link>
          </div>
        </div>
      ...
      <div className="card w-80 bg-base-100 shadow-xl border-2 border-secondary">
        <div className="card-body">
          ...
          <div className="card-actions justify-end mr-2 mt-2 ">
          <Link to="/fundCanada"><button className="btn btn-sm btn-primary text-white">
            Find More
            </button></Link>
          </div>
        </div>
      ...
      <div className="card w-80 bg-base-100 shadow-xl border-2 border-secondary">
        <div className="card-body">
          ...
          <div className="card-actions justify-end mr-2 mt-2 ">
          <Link to="/educationCanada"><button className="btn btn-sm btn-primary text-white">
            Find More
            </button></Link>
          </div>
        </div>
